...
PROCEDURE fnHitungUlangStok
	...
	IF .opggudang01.Value = 1
		=fnRequery("UPDATE material SET qtyb=?tKartuStok.akhir WHERE material_id=?tKartuStok.material_id ")
	ELSE
		=fnRequery("UPDATE material SET qty=?tKartuStok.akhir WHERE material_id=?tKartuStok.material_id ")
	ENDIF	 
	ENDSCAN 
ENDPROC
